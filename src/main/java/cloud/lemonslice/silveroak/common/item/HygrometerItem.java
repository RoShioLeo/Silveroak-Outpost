...
public class HygrometerItem extends NormalItem
{
    ...
    {
        super(new Identifier(MODID, "hygrometer"), new FabricItemSettings().maxCount(1), ItemGroups.TOOLS);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context)
    {
        ...
        {
            tooltip.add(ClientEnvironmentDataHandler.getHumidityInfo());
        }
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand)
    {
        ...
        if (world.isClient())
        {
            user.sendMessage(ClientEnvironmentDataHandler.getHumidityInfo(), true);
        }
