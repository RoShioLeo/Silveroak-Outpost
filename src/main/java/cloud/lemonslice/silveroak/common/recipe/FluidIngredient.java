...
public class FluidIngredient implements Predicate<FluidStack>
{
    ...
    public static IFluidList deserializeFluidList(JsonObject json)
    {
        ...
        else if (json.has("tag"))
        {
            ...
            Tag<Fluid> tag = (Tag<Fluid>) FluidTags.getCollection().get(resourcelocation);
            if (tag == null)
            {
    ...
    public static class TagList implements IFluidList
    {
        ...
        {
            JsonObject jsonobject = new JsonObject();
            jsonobject.addProperty("tag", FluidTags.getCollection().getDirectIdFromTag(this.tag).toString());
